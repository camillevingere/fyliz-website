...
export const pricingPlans4 = [
  {
    title: "ESSAI GRATUIT",
    description: "Découvrez votre potentiel IA",
    descriptionYearly: "Découvrez votre potentiel IA",
    price: 0,
    buttonText: "Commencer maintenant",
    buttonClass:
      "btn btn-md btn-ghost-tertiary border border-dark dark:border-white dark:border-opacity-15 rounded-pill",
    features: [
      "Audit IA personnalisé (997€ offert)",
      "1 automatisation clé en main",
      "Formation équipe 4h incluse",
      "Support 48h/7j pendant 30 jours",
    ],
  },
  {
    title: "ACCÉLÉRATION PRO",
    description: "Résultats garantis en 60 jours",
    descriptionYearly: "Économisez 4 780€ sur l'année",
    price: 1997,
    buttonText: "Réserver ma démo (3 places restantes)",
    buttonClass:
      "btn btn-md btn-primary border border-dark dark:border-white dark:border-opacity-15 rounded-pill",
    features: [
      "10 automatisations personnalisées",
      "ROI de 327% ou remboursement intégral",
      "Support expert 24/7 illimité",
      "Mise à jour et optimisation mensuelle",
